...
public class OccupancySensor extends TimedSensor
     ...
     *
     * The comfort level is calculated as the complement of the
     * percentage given by the current sensor reading divided by
     * the maximum capacity.
     *
     * If the current reading is above the capacity, the comfort level is 0.
     *
     * For example, a sensor with a capacity of 20 people and a current
     * reading of 14 people would have a comfort level of 30.
     * A sensor with a capacity of 15 people and a current reading
     * of 17 people would have a comfort level of 0.
     *
     * Floating point division should be used when performing the calculation,
     * however the resulting floating point number should be
    ...
    public int getComfortLevel() {
        ...
        double occupancyRatio = ((double) currentReading) / this.capacity;
        double occupancyComfort = 100 - (occupancyRatio * 100);
        return (int) Math.round(occupancyComfort);
    }

    /**
     * Returns true if and only if this occupancy sensor
     * is equal to the other given sensor.
     *
     * For two occupancy sensors to be equal,
    ...
    public boolean equals(Object obj) {
        ...
        return super.equals(occupancySensor) &&
                occupancySensor.getCapacity() == this.capacity;
     ...
     *
     * Two occupancy sensors that are equal according
     ...
     * of this occupancy sensor.
     *
     * The format of the string to return is:
     *
     * OccupancySensor:sensorReading1,
     * sensorReading2,...,sensorReadingN:frequency:capacity
     *
     ...
     * sensor's update frequency (in minutes), and 'capacity'
     * is the maximum capacity of the room monitored by this sensor.
     *
    ...
    public String encode() {
        return String.format("OccupancySensor:%s:%d:%d",
                super.encode(),
